...
# Remove the label column and remve NaN values
    data_initial = data_used.drop(columns=['label'])
...
# Number of columns for the plot
    ...
    fig.update_layout(
        title_text=f"Total Samples: {n_normal_samples+number_of_attacks_samples+n_ood_samples}, Normal samples: {number_of_normal_samples}, Attack samples: {number_of_attacks_samples}, OOD samples: {n_ood_samples}")
...
gen_test(input_data, 'ADFANET_normal_only_reduced_ood')
